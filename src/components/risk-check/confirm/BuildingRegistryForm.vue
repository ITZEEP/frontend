...
<template>
  <OCRFormBox title="건축물대장 내용">
    <OCRFormField
      :modelValue="modelValue.대지위치"
      @update:modelValue="(value) => updateField('대지위치', value)"
      label="대지 위치"
      :required="true"
      :error="errors.대지위치"
      :shake="shake"
    ...
    <OCRFormField
      :modelValue="modelValue.용도"
      @update:modelValue="(value) => updateField('용도', value)"
      label="용도"
      :required="true"
      :error="errors.용도"
      :shake="shake"
    ...
    <div>
      <label class="block text-sm font-medium text-gray-warm-700 mb-2"> 위반건축물 여부 </label>
      <BaseCheckbox
        :modelValue="modelValue.위반건축물여부"
        @update:modelValue="(value) => updateField('위반건축물여부', value)"
        label="위반건축물 표시 있음"
      />
    </div>
  </OCRFormBox>
