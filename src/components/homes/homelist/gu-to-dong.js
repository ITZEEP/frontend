// src/components/homes/homecreate/gu-to-dong.js

export const guToDong = {
  "종로구": ["청운효자동", "사직동", "삼청동", "부암동", "평창동", "무악동", "교남동", "가회동", "종로1·2·3·4가동", "종로5·6가동", "이화동", "혜화동"],
  "중구": ["소공동", "회현동", "명동", "필동", "장충동", "광희동", "을지로동", "신당동", "다산동", "황학동", "중림동"],
  ...
  "동대문구": ["용신동", "제기동", "전농1동", "전농2동", "답십리1동", "답십리2동", "장안1동", "장안2동", "청량리동", "회기동", "휘경제1동", "휘경제2동", "이문1동", "이문2동"],
  ...
  "관악구": ["보라매동", "청림동", "행운동", "낙성대동", "청룡동", "은천동", "성현동", "중앙동", "인헌동", "남현동", "서원동", "신원동", "서림동", "난곡동", "신사동", "신림동", "삼성동", "난향동", "조원동", "대학동", "미성동", "서초동"],
